 ...
 */
public class OperasiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_operasi, container, false);
        pasienList = new ArrayList<>();
        recyclerView = (RecyclerView) rootView.findViewById(R.id.rvOperasi);
